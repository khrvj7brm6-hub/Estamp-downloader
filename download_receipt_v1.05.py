...
async def download_receipts():
    ...
    save_dir = BASE_DIR / config["folders"]["receipt_dir"]
    ...
    async with async_playwright() as p:
        ...
        for page_num in range(1, total_pages + 1):
            ...
            icons = await page.query_selector_all("i.fas.fa-file-invoice.fa-stack-1x.fa-inverse")
            ...
            for i, icon in enumerate(icons):
                ...
                try:
                    ...
                    if pdf_data_url:
                        ...
                        filename = save_dir / f"receipt_{script_info['id']}_{formatted_date}.pdf"
                        ...
                        print(f"⚠️ No base64 PDF stream found for receipt {i+1} on page {page_num}")

                except Exception as e:
                    print(f"❌ Failed to process receipt {i+1} on page {page_num}: {e}")
